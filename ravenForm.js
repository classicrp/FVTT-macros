...
*/
	...
	const speedAttr = 'system.attributes.speed.fly.base';	// 50ft || 40ft
	const manAttr = 'system.attributes.speed.fly.maneuverability';	// "perfect" || "average"
	...
	if (state) {
		...
		await actor.update({ [speedAttr]: 40 });					// this works
		await actor.update({ [manAttr]: 'average' });				// this works
