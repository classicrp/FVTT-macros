...
console.log(dWeap);
/*	Sample data: <dWeap>
	<option value="dulDdGPDQ3R0qdPC; mwak; Sap">Sap</option>
	<option value="8OZPgxD0UH77DQBN; mwak; Edge">Edge</option>
	<option value="UnZ55krCR2fjjqbD; mwak; Havok">Havok</option>
	<option value="iBKD1rIWVcgsOZUa; rwak; Mosin-Nagant M1891 Rifle">Mosin-Nagant M1891 Rifle</option>
	<option value="MQ1C3Kh7pkzsCA7i; mwak; Blade Boot">Blade Boot</option>
	<option value="8mG8Lubc6LDS3MXD; rwak; Nagant M1895 Revolver">Nagant M1895 Revolver</option>
	<option value="cu7AHzgO5vppOg7c; twak; Throwing Axe">Throwing Axe</option>
*/
/*	
...
console.log(dBuff);
/*	Sample data: <dBuff>
	<option value="WfazdZHuO1kBrDgH; 1; mwak,rwak,twak; +1 Enhancement">[1] +1 Enhancement</option>
	<option value="D3W5vRe3qk9jFWnQ; 2; mwak,rwak,twak; +2 Enhancement">[2] +2 Enhancement</option>
	<option value="yWxeyssh5gn2eiEQ; 1; mwak; Defending">[1] Defending</option>
	<option value="QbcKGor45N6C3bTk; 1; rwak,twak; Distance">[1] Distance</option>
	<option value="lcIFBPtBzsuKPIwb; 1; mwak,rwak,twak; Ghost Touch">[1] Ghost Touch</option>
	<option value="LMJvQrNHXvcR63d9; 1; mwak,twak; Keen">[1] Keen</option>
	<option value="p6B90547zcsspB4v; 1; mwak; Mighty Cleaving">[1] Mighty Cleaving</option>
	<option value="kl1TRMWwJ72zHCq4; 1; twak; Returning">[1] Returning</option>
	<option value="EfBl4qWhhX0biUmf; 1; mwak,rwak,twak; Shock">[1] Shock</option>
	<option value="HS2MeKbG0SWgSCfJ; 2; mwak,rwak,twak; Shocking Burst">[2] Shocking Burst</option>
	<option value="qnwGIdX5DFtTwYLb; 1; rwak,twak; Seeking">[1] Seeking</option>
	<option value="gcQa23gUupQbZZS9; 3; mwak,rwak; Speed">[3] Speed</option>
	<option value="ybKuhJGDathkdXmt; 2; mwak; Wounding">[2] Wounding</option>
*/
/*
