...
const curEff = await parseInt(foundry.utils.getProperty(item, effect));
const saves = "system.flags.dictionary.saves";
const curSav = await parseInt(foundry.utils.getProperty(item, saves));
